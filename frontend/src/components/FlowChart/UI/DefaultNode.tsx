...
export const DefaultNode = memo(
  ({ data, id, selected }: NodeProps<DefautlAppNode>) => {
    const [contextMenu, setContextMenu] = useState<{
      x: number;
      y: number;
    } | null>(null);
    const { deleteNode, editNodeLabel, updateNodeHandles } =
      useReactFlowStore();
          ...
          >
            <BaseNodeContent>
              ...
              <Handle
                ...
                style={{
                  visibility: data.handles?.right ? "visible" : "hidden",
                }}
              />
              <Handle
                type="source"
              ...
              <Handle
                ...
                style={{
                  visibility: data.handles?.left ? "visible" : "hidden",
                }}
              />
              <Handle
                type="source"
